...
const Index = ({ data, loading, selected, setSelected, handleApplication, handleRemoveApplication }) => {
    ...
    const handleTableMenu = (id, userId, status, option) => {
        if (option === 'View') {
            navigate(`/admin/company/viewDetail/${userId}`, { state: { application: true } })
        }
                ...
                <Table>
                    <TableHead sx={{ background: '#EFEFEF' }}>
                        <TableRow>
                            ...
                            <StyledTableCell>Company founded</StyledTableCell>
                            ...
                            paginatedData.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <StyledTableCell>{item.companySize}</StyledTableCell>
                                        <StyledTableCell>{item.registrationNumber}</StyledTableCell>
                                        <StyledTableCell>{moment(item.establishDate).format('YYYY')}</StyledTableCell>
                                        <StyledTableCell>
                                            <StyledStatus
